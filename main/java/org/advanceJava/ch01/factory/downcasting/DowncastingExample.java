...
public class DowncastingExample {
    ...
    public static void main(String[] args) {
        // Upcasting
        Employee e1 = new Employee(5, "Ismail", 14, "Production");
        e1 = new Manager(5, "Ismail", 14, "Production", "Production");

        Employee e2 = new Employee(1, "Ali", 4, "Production");
        // Downcasting
//		Manager m2 = (Manager) e2; // ClassCastException!
//		m2.manage();  // Runtime hata alinir

//		Director d1 = (Director) new Manager(5, "Ä°smail", 14, "Production", "Production"); // ClassCastException!
